    ...
    <div className="bg-white text-gray-800">
      ...
      <section className="max-w-5xl mx-auto px-6 py-12 text-center">
        ...
        <section className="bg-white py-12 px-4">
            <h2 className="text-center text-2xl font-bold text-blue-900 mb-4">Struktur Kabinet</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-4xl mx-auto mb-4">
                <a href="/kabinet/dewan-pembina" className="block bg-blue-800 text-white text-center py-4 rounded-lg font-semibold hover:bg-[#1e326f] transition">
                Dewan Pembina
                </a>
                <a href="/kabinet/pengurus-inti" className="block bg-blue-800 text-white text-center py-4 rounded-lg font-semibold hover:bg-[#1e326f] transition">
                Pengurus Inti
                </a>
            </div>

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 max-w-6xl mx-auto">
                <a href="/kabinet/medkominfo" className="block bg-blue-800 text-white text-center py-4 rounded-lg font-semibold hover:bg-[#1e326f] transition">
                Divisi MEDKOMINFO
                </a>
                <a href="/kabinet/bisnis-kreatif" className="block bg-blue-800 text-white text-center py-4 rounded-lg font-semibold hover:bg-[#1e326f] transition">
                Divisi Bisnis Kreatif
                </a>
                <a href="/kabinet/humas" className="block bg-blue-800 text-white text-center py-4 rounded-lg font-semibold hover:bg-[#1e326f] transition">
                Divisi Humas
                </a>
                <a href="/kabinet/penasihat" className="block bg-blue-800 text-white text-center py-4 rounded-lg font-semibold hover:bg-[#1e326f] transition">
                Divisi Penasihat
                </a>
            </div>
        </section>
