      ...
      <main className="bg-[#f1f5f9] min-h-screen pt-8">
         <div className="relative h-[300px] md:h-[400px] w-full">
          ...
          <div className="absolute inset-0 flex flex-col justify-center items-center">
            <h1 className="text-3xl md:text-5xl font-bold">Divisi Penasihat </h1>
        ...
        <section className="mt-14 px-4">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-3 gap-4 justify-items-center">
