  ...
  return (
    <div className="bg-white text-gray-800">
      <section className="bg-[url('/back1.jpg')] bg-cover bg-center text-white py-28 text-center">
          <h1 className="text-4xl font-bold pt-16">DIES NATALIS HIMASI dan Sistem Informasi</h1>
          <p className="text-xl mt-4">Tunggu dan jelajahi info terbaru terkait Dies Natalis HIMASI dan Sistem Informasi</p>
      </section>
